...
class Ciphertext:
    ...
    @overload
    def __init__(self, arg0: SEALContext,
                 arg1: List[int[4]], arg2: int) -> None: ...
...
class Encryptor:
    ...
    @overload
    def __init__(self, arg0: SEALContext, arg1: PublicKey,
                 arg2: SecretKey) -> None: ...
...
class Evaluator:
    ...
    def apply_galois(self, arg0: Ciphertext, arg1: int,
                     arg2: GaloisKeys) -> Ciphertext: ...

    def apply_galois_inplace(self, arg0: Ciphertext,
                             arg1: int, arg2: GaloisKeys) -> None: ...

    def complex_conjugate(self, arg0: Ciphertext,
                          arg1: GaloisKeys) -> Ciphertext: ...

    def complex_conjugate_inplace(
        self, arg0: Ciphertext, arg1: GaloisKeys) -> None: ...

    def exponentiate(self, arg0: Ciphertext, arg1: int,
                     arg2: RelinKeys) -> Ciphertext: ...

    def exponentiate_inplace(self, arg0: Ciphertext,
                             arg1: int, arg2: RelinKeys) -> None: ...

    @overload
    def mod_switch_to(self, arg0: Ciphertext,
                      arg1: List[int[4]]) -> Ciphertext: ...

    @overload
    def mod_switch_to(self, arg0: Plaintext,
                      arg1: List[int[4]]) -> Plaintext: ...

    @overload
    def mod_switch_to_inplace(self, arg0: Ciphertext,
                              arg1: List[int[4]]) -> None: ...

    @overload
    def mod_switch_to_inplace(self, arg0: Plaintext,
                              arg1: List[int[4]]) -> None: ...
    ...
    def multiply_many(
        self, arg0: List[Ciphertext], arg1: RelinKeys) -> Ciphertext: ...

    def multiply_plain(self, arg0: Ciphertext,
                       arg1: Plaintext) -> Ciphertext: ...
    def multiply_plain_inplace(
        self, arg0: Ciphertext, arg1: Plaintext) -> None: ...
    ...
    def relinearize_inplace(self, arg0: Ciphertext,
                            arg1: RelinKeys) -> None: ...

    def rescale_to(self, arg0: Ciphertext,
                   arg1: List[int[4]]) -> Ciphertext: ...
    def rescale_to_inplace(self, arg0: Ciphertext,
                           arg1: List[int[4]]) -> None: ...

    def rescale_to_next(self, arg0: Ciphertext) -> Ciphertext: ...
    def rescale_to_next_inplace(self, arg0: Ciphertext) -> None: ...

    def rotate_columns(self, arg0: Ciphertext,
                       arg1: GaloisKeys) -> Ciphertext: ...

    def rotate_columns_inplace(
        self, arg0: Ciphertext, arg1: GaloisKeys) -> None: ...

    def rotate_rows(self, arg0: Ciphertext, arg1: int,
                    arg2: GaloisKeys) -> Ciphertext: ...

    def rotate_rows_inplace(self, arg0: Ciphertext,
                            arg1: int, arg2: GaloisKeys) -> None: ...

    def rotate_vector(self, arg0: Ciphertext, arg1: int,
                      arg2: GaloisKeys) -> Ciphertext: ...
    def rotate_vector_inplace(self, arg0: Ciphertext,
                              arg1: int, arg2: GaloisKeys) -> None: ...
    ...
    @overload
    def transform_to_ntt(self, arg0: Plaintext,
                         arg1: List[int[4]]) -> Plaintext: ...
    ...
    def transform_to_ntt_inplace(
        self, arg0: Plaintext, arg1: List[int[4]]) -> None: ...
...
class KeyGenerator:
    ...
    def create_galois_keys(
        self, arg0: List[int], arg1: GaloisKeys) -> None: ...
...
class SEALContext:
    def __init__(self, parms: EncryptionParameters, expand_mod_chain: bool = True,
                 sec_level: sec_level_type = sec_level_type.tc128) -> None: ...
