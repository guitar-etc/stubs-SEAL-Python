from typing import Any, ClassVar, Iterable, Iterator, List, MutableSequence, overload
...
class CKKSEncoder:
    def __init__(self, arg0: SEALContext) -> None: ...
    def decode(self, arg0: Plaintext) -> NDArray[np.float64]: ...
    @overload
    def encode(self, arg0: NDArray[np.float64], arg1: float) -> Plaintext: ...
    @overload
    def encode(self, arg0: float, arg1: float) -> Plaintext: ...
    def slot_count(self) -> int: ...
...
class Ciphertext:
    ...
    def __init__(self, arg0: SEALContext) -> None: ...
    @overload
    def __init__(self, arg0: SEALContext, arg1: List[int[4]]) -> None: ...
    @overload
    def __init__(self, arg0: SEALContext, arg1: List[int[4]], arg2: int) -> None: ...
    @overload
    def __init__(self, arg0: Ciphertext) -> None: ...
    def coeff_modulus_size(self) -> int: ...
    def is_ntt_form(self) -> bool: ...
    def is_transparent(self) -> bool: ...
    def load(self, arg0: SEALContext, arg1: str) -> None: ...
    def parms_id(self) -> List[int[4]]: ...
...
class CoeffModulus:
    ...
    def BFVDefault(self, *args, **kwargs) -> Any: ...
    def Create(self, *args, **kwargs) -> Any: ...
    def MaxBitCount(self, *args, **kwargs) -> Any: ...
...
class EncryptionParameters:
    @overload
    def __init__(self, arg: scheme_type) -> None: ...
    @overload
    def __init__(self, arg: EncryptionParameters) -> None: ...
    def set_poly_modulus_degree(self, arg: std_size_t) -> None: ...
    def set_coeff_modulus(self, arg: std_vector[Modulus]) -> None: ...
    @overload
    def set_plain_modulus(self, arg: Modulus) -> None: ...
    @overload
    def set_plain_modulus(self, arg: std_uint64_t) -> None: ...
    def scheme(self) -> scheme_type: ...
    def poly_modulus_degree(self) -> std_size_t: ...
    def coeff_modulus(self) -> std_vector[Modulus]: ...
    def plain_modulus(self) -> Modulus: ...
    def save(self, path: std_string) -> None: ...
    def load(self, path: std_string) -> None: ...
    def __getstate__(self) -> tuple[std_string]: ...
    def __setstate__(self, t: tuple[std_string]) -> None: ...
...
class Encryptor:
    ...
    def __init__(self, arg0: SEALContext, arg1: SecretKey) -> None: ...
    @overload
    def __init__(self, arg0: SEALContext, arg1: PublicKey, arg2: SecretKey) -> None: ...
...
class Evaluator:
    ...
    def apply_galois(self, arg0: Ciphertext, arg1: int, arg2: GaloisKeys) -> Ciphertext: ...
    def apply_galois_inplace(self, arg0: Ciphertext, arg1: int, arg2: GaloisKeys) -> None: ...
    def complex_conjugate(self, arg0: Ciphertext, arg1: GaloisKeys) -> Ciphertext: ...
    def complex_conjugate_inplace(self, arg0: Ciphertext, arg1: GaloisKeys) -> None: ...
    def exponentiate(self, arg0: Ciphertext, arg1: int, arg2: RelinKeys) -> Ciphertext: ...
    def exponentiate_inplace(self, arg0: Ciphertext, arg1: int, arg2: RelinKeys) -> None: ...
    @overload
    def mod_switch_to(self, arg0: Ciphertext, arg1: List[int[4]]) -> Ciphertext: ...
    @overload
    def mod_switch_to(self, arg0: Plaintext, arg1: List[int[4]]) -> Plaintext: ...
    @overload
    def mod_switch_to_inplace(self, arg0: Ciphertext, arg1: List[int[4]]) -> None: ...
    @overload
    def mod_switch_to_inplace(self, arg0: Plaintext, arg1: List[int[4]]) -> None: ...
    @overload
    ...
    def multiply_many(self, arg0: List[Ciphertext], arg1: RelinKeys) -> Ciphertext: ...
    def multiply_plain(self, arg0: Ciphertext, arg1: Plaintext) -> Ciphertext: ...
    def multiply_plain_inplace(self, arg0: Ciphertext, arg1: Plaintext) -> None: ...
    ...
    def relinearize_inplace(self, arg0: Ciphertext, arg1: RelinKeys) -> None: ...
    def rescale_to(self, arg0: Ciphertext, arg1: List[int[4]]) -> Ciphertext: ...
    def rescale_to_inplace(self, arg0: Ciphertext, arg1: List[int[4]]) -> None: ...
    def rescale_to_next(self, arg0: Ciphertext) -> Ciphertext: ...
    def rescale_to_next_inplace(self, arg0: Ciphertext) -> None: ...
    def rotate_columns(self, arg0: Ciphertext, arg1: GaloisKeys) -> Ciphertext: ...
    def rotate_columns_inplace(self, arg0: Ciphertext, arg1: GaloisKeys) -> None: ...
    def rotate_rows(self, arg0: Ciphertext, arg1: int, arg2: GaloisKeys) -> Ciphertext: ...
    def rotate_rows_inplace(self, arg0: Ciphertext, arg1: int, arg2: GaloisKeys) -> None: ...
    def rotate_vector(self, arg0: Ciphertext, arg1: int, arg2: GaloisKeys) -> Ciphertext: ...
    def rotate_vector_inplace(self, arg0: Ciphertext, arg1: int, arg2: GaloisKeys) -> None: ...
    ...
    @overload
    def transform_to_ntt(self, arg0: Plaintext, arg1: List[int[4]]) -> Plaintext: ...
    @overload
    def transform_to_ntt(self, arg0: Ciphertext) -> Ciphertext: ...
    @overload
    def transform_to_ntt_inplace(self, arg0: Plaintext, arg1: List[int[4]]) -> None: ...
    @overload
...
class KeyGenerator:
    ...
    def __init__(self, arg0: SEALContext, arg1: SecretKey) -> None: ...
    @overload
    def create_galois_keys(self, arg0: List[int], arg1: GaloisKeys) -> None: ...
    @overload
    def create_galois_keys(self, arg0: GaloisKeys) -> None: ...
    @overload
    def create_galois_keys(self) -> GaloisKeys: ...
    @overload
    def create_public_key(self, arg0: PublicKey) -> None: ...
    @overload
    def create_public_key(self) -> PublicKey: ...
    @overload
    def create_relin_keys(self, arg0: RelinKeys) -> None: ...
    @overload
...
class Plaintext:
    ...
    @overload
    def __init__(self, arg0: Plaintext) -> None: ...
...
class PublicKey:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, arg0: PublicKey) -> None: ...
    def load(self, arg0: SEALContext, arg1: str) -> None: ...
    def parms_id(self) -> List[int[4]]: ...
    def save(self, arg0: str) -> None: ...
...
class SEALContext:
    def __init__(self, arg0: EncryptionParameters, arg1: bool = ..., arg2: sec_level_type = ...) -> None: ...
    def first_context_data(self) -> ContextData: ...
    def first_parms_id(self) -> MutableSequence[np.uint64]: ...
    # def first_parms_id(self) -> List[int[4]]: ...

    # using hash_block_type = std::array<std::uint64_t, hash_block_uint64_count>;
    def get_context_data(self, arg0: List[int[4]]) -> ContextData: ...
    def key_context_data(self) -> ContextData: ...
    def last_context_data(self) -> ContextData: ...
    def last_parms_id(self) -> List[int[4]]: ...
    def parameters_set(self) -> bool: ...
